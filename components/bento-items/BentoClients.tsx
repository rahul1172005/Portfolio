    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-start w-full relative gap-6 p-5 md:p-12 z-20">
                {/* TEXT BLOCK */}
                <div className="flex flex-col gap-2 relative max-w-[50%]">
                    <h3 className="text-lg sm:text-xl md:text-3xl lg:text-4xl font-black text-black leading-none tracking-tight uppercase">
                        CREATING WHAT<br />
                        DOESN'T EXIST YET
                    </h3>
